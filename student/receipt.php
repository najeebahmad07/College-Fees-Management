...
$stmt = $conn->prepare("SELECT p.*,
                       ...
                       WHERE p.id = ? AND p.student_id = ? AND p.payment_status = 'success'");
...
$html = '<table border="0" cellpadding="4">
    ...
    <tr>
        ...
        <td><strong>Payment Method:</strong> Online (Razorpay)</td>
    </tr>
</table>';
...
$pdf->MultiCell(0, 5, 'Payment received through Razorpay Payment Gateway. This is a computer-generated receipt and does not require a physical signature.', 0, 'L');
$pdf->Ln(5);
